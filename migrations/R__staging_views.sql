...
FROM 
  "DEV_DATAMART_DB"."SCHEMA_CHANGE_TEST"."STUDY_STG" AS STUDY_STG 
  LEFT JOIN "DEV_DATAMART_DB"."SCHEMA_CHNAGE_DATAMART"."VW_SOURCE" AS VW_SOURCE ON VW_SOURCE.SOURCE = STUDY_STG.SOURCE
...
FROM 
  "DEV_DATAMART_DB"."SCHEMA_CHANGE_TEST"."STUDY_STG" AS STUDY_STG 
  LEFT JOIN "DEV_DATAMART_DB"."SCHEMA_CHNAGE_DATAMART"."VW_STUDY_FAMILY" AS STUDY_FAMILY ON STUDY_FAMILY.STUDY_FAMILY = STUDY_STG.STUDY_FAMILY 
  LEFT JOIN "DEV_DATAMART_DB"."SCHEMA_CHNAGE_DATAMART"."VW_STUDY_RELEASE" AS STUDY_RELEASE ON STUDY_STG.STUDY_RELEASE = STUDY_RELEASE.STUDY_RELEASE 
  LEFT JOIN "DEV_DATAMART_DB"."SCHEMA_CHNAGE_DATAMART"."VW_STUDY_TYPE" AS STUDY_TYPE ON STUDY_STG.STUDY_TYPE = STUDY_TYPE.STUDY_TYPE 
  LEFT JOIN "DEV_DATAMART_DB"."SCHEMA_CHNAGE_DATAMART"."VW_TREND_FAMILY" AS TREND_FAMILY ON STUDY_STG.TREND_FAMILY = TREND_FAMILY.TREND_FAMILY
  LEFT JOIN "DEV_DATAMART_DB"."SCHEMA_CHNAGE_DATAMART"."VW_USER_INFO" on VW_USER_INFO.FIRST_NAME = 'ETL_USER';
...
WITH DICTIONARY_ITEM AS (
  ...
  FROM 
    "DEV_DATAMART_DB"."SCHEMA_CHANGE_TEST"."DICTIONARY_ITEM_STG" as DICTIONARY_STG, 
    LATERAL FLATTEN(
...
from 
  NEW_FULL_LABEL 
  join "DEV_DATAMART_DB"."SCHEMA_CHANGE_TEST"."DICTIONARY_ITEM_STG" on NEW_FULL_LABEL.FULL_LABEL = DICTIONARY_ITEM_STG.FULL_LABEL;
...
WITH DICTIONARY_ITEM_TEXT AS (
  SELECT
    FLATTEN_LABEL.VALUE :: STRING AS TEXT
  FROM
    "DEV_DATAMART_DB"."SCHEMA_CHANGE_TEST".VW_DICTIONARY_ITEM_STG,
    LATERAL FLATTEN(
      INPUT => SPLIT(FULL_LABEL, '|')
    ) FLATTEN_LABEL
  UNION
  ...
  FROM
    "DEV_DATAMART_DB"."SCHEMA_CHANGE_TEST".VW_DICTIONARY_ITEM_STG UNPIVOT(
      TEXT FOR LEVEL IN (
...
ID_OF_ITEM_TEXT AS (
  ...
  FROM
    ...
    LEFT JOIN "DEV_DATAMART_DB"."SCHEMA_CHNAGE_DATAMART".ITEM_TEXT AS ITEM_TEXT ON DICTIONARY_ITEM_TEXT.TEXT = ITEM_TEXT.TEXT
),
...
ID_OF_ITEM_TEXT_IGNORING_CASE AS (
  ...
  FROM
    ID_OF_ITEM_TEXT
    LEFT JOIN "DEV_DATAMART_DB"."SCHEMA_CHNAGE_DATAMART".ITEM_TEXT AS ITEM_TEXT ON UPPER(ID_OF_ITEM_TEXT.TEXT) = UPPER(ITEM_TEXT.TEXT)
  WHERE
...
ID_OF_ITEM_TEXT_USING_REGEX AS (
  ...
  FROM
    ...
    LEFT JOIN "DEV_DATAMART_DB"."SCHEMA_CHNAGE_DATAMART".ITEM_TEXT AS ITEM_TEXT ON LOWER(
      REGEXP_REPLACE(
        ID_OF_ITEM_TEXT_IGNORING_CASE.TEXT,
        '[" ",\n]', ''
      )
...
PROCESSED_DICTIONARY AS (
  SELECT 
    "DEV_DATAMART_DB"."SCHEMA_CHANGE_TEST"."SEQ_DICTIONARY_ITEM".NEXTVAL AS DICTIONARY_ITEM_ID, 
    * 
  FROM 
    (
      SELECT 
...
FROM 
  ...
  LEFT JOIN (
    SELECT 
      * 
    FROM 
      "DEV_DATAMART_DB"."SCHEMA_CHANGE_TEST"."VW_ITEM_TEXT" QUALIFY ROW_NUMBER() OVER (
        PARTITION BY TEXT 
        ORDER BY 
          TEXT_ID ASC
      ) = 1
  ) as ITEM_TEXT ON ITEM_TEXT.TEXT = PROCESSED_DICTIONARY.TEXT 
  LEFT JOIN "DEV_DATAMART_DB"."SCHEMA_CHNAGE_DATAMART"."VW_DICTIONARY_ITEM_TYPE" ON VW_DICTIONARY_ITEM_TYPE.TYPE = PROCESSED_DICTIONARY.DICTIONARY_ITEM_TYPE 
  LEFT JOIN "DEV_DATAMART_DB"."SCHEMA_CHANGE_TEST"."VW_STUDY_STG" as STUDY ON STUDY.DP_STUDYID = PROCESSED_DICTIONARY.STUDY_ID 
  LEFT JOIN "DEV_DATAMART_DB"."SCHEMA_CHANGE_TEST"."VW_DICTIONARY_STG" as DICTIONARY on DICTIONARY.STUDY_ID = STUDY.ID
  ...
  LEFT JOIN "DEV_DATAMART_DB"."SCHEMA_CHNAGE_DATAMART"."VW_USER_INFO" on VW_USER_INFO.FIRST_NAME = PROCESSED_DICTIONARY.USERNAME
  LEFT JOIN "DEV_DATAMART_DB"."SCHEMA_CHNAGE_DATAMART"."VW_DATA_TYPE" on LOWER(PROCESSED_DICTIONARY.DATA_TYPE) = LOWER(VW_DATA_TYPE.DATA_TYPE)
ORDER BY
   DICTIONARY_ITEM_SORT
);
...
from 
  ...
  LEFT JOIN "DEV_DATAMART_DB"."SCHEMA_CHNAGE_DATAMART"."VW_DICTIONARY_ITEM_TYPE" ON LOWER(VW_DICTIONARY_ITEM_TYPE.TYPE) = LOWER(
    PROCESSED_MEMRI.DICTIONARY_ITEM_TYPE
  ) 
  LEFT JOIN "DEV_DATAMART_DB"."SCHEMA_CHANGE_TEST"."VW_STUDY_STG" as STUDY ON STUDY.DP_STUDYID = PROCESSED_MEMRI.STUDY_ID 
  LEFT JOIN "DEV_DATAMART_DB"."SCHEMA_CHANGE_TEST"."VW_DICTIONARY_STG" as DICTIONARY on DICTIONARY.STUDY_ID = STUDY.ID 
  ...
  LEFT JOIN "DEV_DATAMART_DB"."SCHEMA_CHNAGE_DATAMART"."VW_USER_INFO" on VW_USER_INFO.FIRST_NAME = PROCESSED_MEMRI.USERNAME 
  LEFT JOIN "DEV_DATAMART_DB"."SCHEMA_CHNAGE_DATAMART"."VW_DATA_TYPE" on LOWER(PROCESSED_MEMRI.DATA_TYPE) = LOWER(VW_DATA_TYPE.DATA_TYPE) 
order by 
  DICTIONARY_ITEM_SORT
);
...
WITH NEW_ATTRIBUTE as (
  ...
  FROM 
    "DEV_DATAMART_DB"."SCHEMA_CHANGE_TEST"."ATTRIBUTE_STG" QUALIFY ROW_NUMBER() OVER (
  ...
  SELECT 
    UPPER(NAME) as NAME
  FROM 
    "DEV_DATAMART_DB"."SCHEMA_CHNAGE_DATAMART"."VW_ATTRIBUTE" QUALIFY ROW_NUMBER() OVER (
      PARTITION BY NAME
      ORDER BY 
        NAME
    ) = 1
...
NEW_ATTRIBUTE as (
  ...
  from 
    UNIQUE_ATTRIBUTE 
    join "DEV_DATAMART_DB"."SCHEMA_CHNAGE_DATAMART"."VW_ATTRIBUTE_TYPE" on VW_ATTRIBUTE_TYPE.ATTRIBUTE_TYPE = UPPER(
      UNIQUE_ATTRIBUTE.ATTRIBUTE_TYPE
    ) 
    join "DEV_DATAMART_DB"."SCHEMA_CHNAGE_DATAMART"."VW_ATTRIBUTE" on VW_ATTRIBUTE.NAME = UNIQUE_ATTRIBUTE.ATTRIBUTE 
  except 
  select 
    ATTRIBUTE_ID, 
    ATTRIBUTE_TYPE_ID, 
    ...
    ATTRIBUTE_KEY 
  from 
    DEV_DATAMART_DB.SCHEMA_CHNAGE_DATAMART.ATTRIBUTE_MASTER
) 
select 
  ATTRIBUTE_TYPE_ID, 
  ATTRIBUTE_VALUE, 
...
WITH NEW_ATTRIBUTE_TYPE as (
  ...
  SELECT 
    ATTRIBUTE_TYPE 
  FROM 
    "DEV_DATAMART_DB"."SCHEMA_CHNAGE_DATAMART"."VW_ATTRIBUTE_TYPE" QUALIFY ROW_NUMBER() OVER (
      PARTITION BY ATTRIBUTE_TYPE 
      ORDER BY 
        ATTRIBUTE_TYPE
    ) = 1
...
from 
  "DEV_DATAMART_DB"."SCHEMA_CHANGE_TEST"."ATTRIBUTE_STG" 
  join "DEV_DATAMART_DB"."SCHEMA_CHANGE_TEST"."STUDY_STG" on ATTRIBUTE_STG.DP_STUDY_ID = STUDY_STG.DP_STUDY_ID 
  left join DEV_DATAMART_DB.SCHEMA_CHNAGE_DATAMART.VW_STUDY_FAMILY on STUDY_STG.STUDY_FAMILY = VW_STUDY_FAMILY.STUDY_FAMILY
  join "DEV_DATAMART_DB"."SCHEMA_CHNAGE_DATAMART"."VW_USER_INFO" on VW_USER_INFO.FIRST_NAME = 'ETL_USER' 
  join "DEV_DATAMART_DB"."SCHEMA_CHNAGE_DATAMART"."VW_ATTRIBUTE_TYPE" on VW_ATTRIBUTE_TYPE.ATTRIBUTE_TYPE = UPPER(ATTRIBUTE_STG.ATTRIBUTE_TYPE) 
  join "DEV_DATAMART_DB"."SCHEMA_CHNAGE_DATAMART"."VW_ATTRIBUTE" on VW_ATTRIBUTE.NAME = ATTRIBUTE_STG.ATTRIBUTE 
  join "DEV_DATAMART_DB"."SCHEMA_CHNAGE_DATAMART"."ATTRIBUTE_MASTER" on ATTRIBUTE_MASTER.ATTRIBUTE_TYPE_ID = VW_ATTRIBUTE_TYPE.ATTRIBUTE_TYPE_ID 
...
FROM 
  ...
  JOIN "DEV_DATAMART_DB"."SCHEMA_CHNAGE_DATAMART"."VW_ACTION_TYPE" on UPPER(VW_ACTION_TYPE.NAME) = 'UPDATE'
  JOIN "DEV_DATAMART_DB"."SCHEMA_CHNAGE_DATAMART"."VW_USER_INFO" on VW_USER_INFO.FIRST_NAME = 'ETL_USER'
WHERE 
...
WITH INSIGHT_DICTIONARY_ITEM AS (
  ...
  from 
    "DEV_DATAMART_DB"."SCHEMA_CHANGE_TEST"."VW_INSIGHT_DICTIONARY_ITEM"
), 
MEMRI_DICTIONARY_ITEM AS (
  ...
  from 
    "DEV_DATAMART_DB"."SCHEMA_CHANGE_TEST"."VW_MEMRI_DICTIONARY_ITEM"
), 
MASTER_LOOKUP_UNIQUE_EXTERNAL_KEY AS(
  SELECT 
    * 
  FROM 
    "DEV_DATAMART_DB"."SCHEMA_CHNAGE_DATAMART"."VW_MASTER_LOOKUP" as VW_MASTER_LOOKUP QUALIFY ROW_NUMBER() OVER (
...
PROCESSED_DICTIONARY AS (
  ...
  FROM 
    ...
    JOIN "DEV_DATAMART_DB"."SCHEMA_CHANGE_TEST"."VW_STUDY_STG" ON INSIGHT_DICTIONARY_ITEM.DICTIONARY_ID = VW_STUDY_STG.DICTIONARY_ID 
    JOIN "DEV_DATAMART_DB"."SCHEMA_CHNAGE_DATAMART"."VW_STUDY_FAMILY" ON VW_STUDY_FAMILY.ID = VW_STUDY_STG.STUDY_FAMILY_ID 
    JOIN "DEV_DATAMART_DB"."SCHEMA_CHNAGE_DATAMART"."VW_STUDY_TYPE" ON VW_STUDY_TYPE.ID = VW_STUDY_STG.STUDY_TYPE_ID
), 
...
EXTERNAL_KEYWORD AS (
  SELECT 
    ...
    LOWER(
      "DEV_DATAMART_DB"."SCHEMA_CHANGE_TEST".FN_CLEAN_HIERARCHY_TEXT(
...
STUDY_HEIRARCHY_TEXT_ADD_PERSISTENT_ID as (
  SELECT 
    ...
    STUDY_HEIRARCHY_TEXT_REMOVED_PUNTUATION.PREFIX || "DEV_DATAMART_DB"."SCHEMA_CHANGE_TEST"."SEQ_PERSISTENT_ID".NEXTVAL AS PERSISTENT_ID 
  FROM 
    (
      SELECT 
        * 
...
from 
  "DEV_DATAMART_DB"."SCHEMA_CHANGE_TEST"."WEIGHT_STG" 
  join "DEV_DATAMART_DB"."SCHEMA_CHNAGE_DATAMART"."VW_WEIGHT_TYPE" on WEIGHT_STG.WEIGHT_TYPE = VW_WEIGHT_TYPE.WEIGHT_TYPE 
  join "DEV_DATAMART_DB"."SCHEMA_CHNAGE_DATAMART"."VW_WEIGHT_EXTENSION" on WEIGHT_STG.EXTENSION = VW_WEIGHT_EXTENSION.WEIGHT_EXTENSION
  join "DEV_DATAMART_DB"."SCHEMA_CHANGE_TEST"."STUDY_STG" on WEIGHT_STG.DP_STUDY_ID = STUDY_STG.DP_STUDY_ID
  join "DEV_DATAMART_DB"."SCHEMA_CHNAGE_DATAMART"."VW_USER_INFO" on VW_USER_INFO.FIRST_NAME = 'ETL_USER';
...
select 
  ...
  NULL as UPD_TS
from 
  "DEV_DATAMART_DB"."SCHEMA_CHANGE_TEST"."SUPPRESSION_STG" 
  join "DEV_DATAMART_DB"."SCHEMA_CHNAGE_DATAMART"."VW_USER_INFO" on VW_USER_INFO.FIRST_NAME = 'ETL_USER'
  join "DEV_DATAMART_DB"."SCHEMA_CHNAGE_DATAMART"."VW_DELIVERABLE" on VW_DELIVERABLE.DELIVERABLE = 'Both';
...
WITH NEW_WEIGHT_EXTENSION as (
  SELECT 
    EXTENSION 
  FROM 
    "DEV_DATAMART_DB"."SCHEMA_CHANGE_TEST"."WEIGHT_STG" QUALIFY ROW_NUMBER() OVER (
  ...
  SELECT 
    WEIGHT_EXTENSION 
  FROM 
    "DEV_DATAMART_DB"."SCHEMA_CHNAGE_DATAMART"."VW_WEIGHT_EXTENSION" QUALIFY ROW_NUMBER() OVER (
...
WITH NEW_WEIGHT_TYPE AS (
  ...
  SELECT 
    WEIGHT_TYPE 
  FROM 
    "DEV_DATAMART_DB"."SCHEMA_CHNAGE_DATAMART"."VW_WEIGHT_TYPE" QUALIFY ROW_NUMBER() OVER (
      PARTITION BY WEIGHT_TYPE 
      ORDER BY 
        WEIGHT_TYPE
    ) = 1
